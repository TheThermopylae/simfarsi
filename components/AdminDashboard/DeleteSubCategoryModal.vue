  ...
  <div>
    ...
    >
      <div class="flex justify-between items-center">
        ...
        <h2>حذف زیر دسته بندی</h2>
      </div>
      <p class="my-5">آیا میخواهید این زیر دسته بندی را حذف کنید؟</p>
...
async function deleteSubCategoryFunc () {
  try {
    loading.value = true
    ...
    let data = await $fetch(`/api/admin/categories/deleteSubCategory`, {
      ...
      body: { categoryid: props.data[0], subcategoryId: props.data[1] }
    })

    toast.success(' زیر  دسته بندی شما با موفقیت حذف شد')
    emit('acceptDelete')
    emit('closeModal')
  } catch (error) {
