<template>
  <div class="text-center">
    <div class="my-1">
      <h4>زیر دسته بندی {{ props.subcategory.title }}</h4>
    </div>
    <div class="flex justify-center flex-row-reverse gap-2">
      <div class="lg:tooltip" data-tip="حذف زیر دسته بندی">
      ...
      <div class="lg:tooltip" data-tip="ویرایش زیر دسته بندی">
    ...
    <Dialog
      ...
      modal
      header="حدف زیر دسته بندی"
      class="w-11/12 md:w-2/3 lg:w-2/5 xl:w-1/4"
    >
      <span class="text-surface-500 dark:text-surface-400 block mb-8"
        >آیا میخواهید این زیر دسته بندی <b>{{ props.subcategory.title }}</b> را
        حذف کنید؟</span
      >
    ...
    <Dialog
      ...
      modal
      :header="`ویرایش زیر دسته بندی ${props.subcategory.title}`"
      class="w-11/12 md:w-2/3 lg:w-2/5 xl:w-1/4"
    >
      ...
      <div class="flex items-center gap-4 mb-8">
        ...
        <InputText
          ...
          class="flex-auto"
          autocomplete="off"
          v-model="props.subcategory.href"
        />
      </div>
      <div class="grid grid-cols-2 gap-2">
        <Button
...
function closeEditModal () {
  ...
  title.value = props.subcategory.title
}
...
async function removeCategory () {
  ...
  try {
    let data = await $fetch('/api/admin/categories/deleteSubCategory', {
      credentials: 'include',
      body: {
...
async function editCategory () {
  if (!title.value || !props.subcategory.href)
